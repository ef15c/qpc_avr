...
/*$define${Events::pauseEvt} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/

/*${Events::pauseEvt} ......................................................*/
QEvt const pauseEvt = {PAUSE_SIG, 0U};
/*$enddef${Events::pauseEvt} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
/*$define${Events::serveEvt} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/

/*${Events::serveEvt} ......................................................*/
QEvt const serveEvt = {SERVE_SIG, 0U};
/*$enddef${Events::serveEvt} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
...
extern QEvt const Table_eatEvt;
...
#define LEFT(n_) ((uint8_t)(((n_) + (N_PHILO - 1U)) % N_PHILO))
#define RIGHT(n_)  ((uint8_t)(((n_) + 1U) % N_PHILO))
...
/*${AOs::Table} ............................................................*/
QEvt const Table_eatEvt = {EAT_SIG, 0U};
        ...
        case Q_ENTRY_SIG: {
            ...
            for (n = 0U; n < N_PHILO; ++n) { /* give permissions to eat... */
                    ...
                    && (me->fork[n] == FREE))
                {
                    ...
                    me->fork[LEFT(n)] = USED;
                    BSP_displayForkStat(LEFT(n), "used");
                    me->fork[n] = USED;
                    BSP_displayForkStat(n, "used");
                    philo = AO_Philo[n];
